---
title: "Example 4: SqlHandle with scroll cursor"
source: "fgl-topics/c_fgl_ClassSqlHandle_example_4.html"
breadcrumb: "Library reference > Built-in packages > The base package > The SqlHandle class > Examples > Example 4: SqlHandle with scroll cursor"
type: "concept"
description: "The following code implements an insert cursor with the base.SqlHandle API: MAIN DEFINE h base.SqlHandle CONNECT TO \":memory:+driver='dbmsqt'\" CALL create_table() LET h = base.SqlHandle.create() CALL ..."
---
