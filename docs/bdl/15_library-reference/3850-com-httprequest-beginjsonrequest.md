---
title: "com.HttpRequest.beginJSONRequest"
source: "fgl-topics/c_gws_ComHTTPRequest_beginJSONRequest.html"
breadcrumb: "Library reference > Extension packages > The com package > HTTP classes > The HttpRequest class > HttpRequest methods > com.HttpRequest.beginJSONRequest"
type: "concept"
---
...
The `beginJSONRequest()` starts a streaming HTTP request and returns a [JSONWriter](3618-the-json-jsonwriter-class.md "The json.JSONWriter class provides an interface compatible with JSON streaming that writes data in a JSON format to an output source.") object ready to send to the server.
