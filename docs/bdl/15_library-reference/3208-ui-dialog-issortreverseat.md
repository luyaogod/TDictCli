---
title: "ui.Dialog.isSortReverseAt"
source: "fgl-topics/c_fgl_ClassDialog_isSortReverseAt.html"
breadcrumb: "Library reference > Built-in packages > The ui package > The Dialog class > ui.Dialog methods > ui.Dialog.isSortReverseAt"
type: "concept"
---
...
The `isSortReverseAt()` method returns `FALSE` if the sort order is
ascending, and `TRUE` if the sort is in descending order, for the record list
identified by the screen record name, and the sort column position specified by
index parameter.
