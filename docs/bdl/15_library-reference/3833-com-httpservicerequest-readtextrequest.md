---
title: "com.HttpServiceRequest.readTextRequest"
source: "fgl-topics/c_gws_ComHTTPServiceRequest_readTextRequest.html"
breadcrumb: "Library reference > Extension packages > The com package > Web services classes > The HttpServiceRequest class > HttpServiceRequest methods > com.HttpServiceRequest.readTextRequest"
type: "concept"
---
...
The request Content-Type header can be of any form `*/*`. For example:
`application/json`.
