---
title: "JSONOneOf"
source: "fgl-topics/c_gws_JSON_attribute_JSONOneOf.html"
breadcrumb: "Library reference > Extension packages > The json package > The streaming API for JSON classes > The json.Serializer class > json.Serializer attributes > JSONOneOf"
type: "concept"
---
...
Every `JSONOneOf` record must include one field marked with [`JSONSelector`](3684-jsonselector.md "Identifies the variant member of a JSONOneOf record to use during serialization or deserialization."). At runtime, you
...
When defining schemas, keep in mind how Genero BDL types map to JSON types; see [OpenAPI types mapping: BDL](../16_web-services/4847-openapi-types-mapping-bdl.md "Conversion mapping for Genero BDL data types in OpenAPI documentation.").

During deserialization, error [-15807](4483-genero-bdl-errors.md) is
...
approach using `JSONAdditionalProperties`, see [Example 3: using JSONOneOf with JSONAdditionalProperties](3678-jsonadditionalproperties.md).
