---
title: "util.Integer.clearBit"
source: "fgl-topics/c_fgl_ext_util_Integer_clearBit.html"
breadcrumb: "Library reference > Extension packages > The util package > The util.Integer class > util.Integer methods > util.Integer.clearBit"
type: "concept"
---
...
The `util.Integer.clearBit()` method modifies the integer value by clearing the
bit at the position passed as second parameter.
...
IMPORT util
MAIN
    DISPLAY util.Integer.clearBit( 34, 5 ) -- displays 2
END MAIN
```
