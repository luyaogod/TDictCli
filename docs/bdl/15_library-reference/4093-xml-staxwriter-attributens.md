---
title: "xml.StaxWriter.attributeNS"
source: "fgl-topics/c_gws_XmlStaxWriter_attributeNS.html"
breadcrumb: "Library reference > Extension packages > The xml package > The streaming API for XML (StAX) classes > The StaxWriter class > xml.StaxWriter methods > xml.StaxWriter.attributeNS"
type: "concept"
---
...
1. name defines the local name of the XML attribute, cannot be NULL.
2. ns defines the namespace URI of the XML attribute, cannot be NULL.
3. value defines the value of the XML attribute, cannot be NULL.
