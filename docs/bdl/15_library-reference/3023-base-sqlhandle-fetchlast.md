---
title: "base.SqlHandle.fetchLast"
source: "fgl-topics/c_fgl_ClassSqlHandle_fetchLast.html"
breadcrumb: "Library reference > Built-in packages > The base package > The SqlHandle class > base.SqlHandle methods > base.SqlHandle.fetchLast"
type: "concept"
---
...
Call the `fetchLast()` method to fetch the last row in a scrollable SQL result
set.
...
If the result set is empty, or if the current row is already the last row,
