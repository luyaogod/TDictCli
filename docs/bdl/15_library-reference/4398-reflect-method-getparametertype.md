---
title: "reflect.Method.getParameterType"
source: "fgl-topics/c_fgl_ext_reflect_Method_getParameterType.html"
breadcrumb: "Library reference > Extension packages > The reflect package > The reflect.Method class > reflect.Method methods > reflect.Method.getParameterType"
type: "concept"
---
...
The `getParameterType()` method returns a [`reflect.Type`](4379-the-reflect-type-class.md "The reflect.Type class is a generic API to inspect types.") object representing the type of the method parameter at the
