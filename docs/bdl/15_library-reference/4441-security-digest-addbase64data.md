---
title: "security.Digest.AddBase64Data"
source: "fgl-topics/c_gws_SecurityDigest_AddBase64Data.html"
breadcrumb: "Library reference > Extension packages > The security package > The Digest class > Digest methods > security.Digest.AddBase64Data"
type: "concept"
---
...
1. toDigest defines the base64 data string to be added to the
   digest buffer.

## Usage

Use the method to decode the given base64 string and add the binary data to the digest
buffer.
