---
title: "com.HttpServiceRequest.readXmlRequest"
source: "fgl-topics/c_gws_ComHTTPServiceRequest_readXmlRequest.html"
breadcrumb: "Library reference > Extension packages > The com package > Web services classes > The HttpServiceRequest class > HttpServiceRequest methods > com.HttpServiceRequest.readXmlRequest"
type: "concept"
---
...
The `readXmlRequest()` method returns the request as an entire XML document,
contained in a [`xml.DomDocument`](3959-the-domdocument-class.md "The xml.DomDocument class provides methods to manipulate a data tree, following the DOM standards.")
object.
