---
title: "com.HttpRequest.endJSONRequest"
source: "fgl-topics/c_gws_ComHTTPRequest_endJSONRequest.html"
breadcrumb: "Library reference > Extension packages > The com package > HTTP classes > The HttpRequest class > HttpRequest methods > com.HttpRequest.endJSONRequest"
type: "concept"
---
...
1. json defines the `json.JSONWriter` object used to write the
   HTTP request.

## Usage

The `endJSONRequest()` method terminates a streaming HTTP request by closing the
`json.JSONWriter` object that was created with the [beginJSONRequest](3850-com-httprequest-beginjsonrequest.md "Starts a HTTP request streaming JSON.") method.
