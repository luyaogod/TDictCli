---
title: "com.TcpRequest.doTextRequest"
source: "fgl-topics/c_gws_ComTCPRequest_doTextRequest.html"
breadcrumb: "Library reference > Extension packages > The com package > TCP classes > The TcpRequest class > TcpRequest methods > com.TcpRequest.doTextRequest"
type: "concept"
---
...
1. str defines the string describing the
   request.

## Usage

The `doTextRequest()` method performs the TCP request by using the information
defined in the string passed as parameter.
