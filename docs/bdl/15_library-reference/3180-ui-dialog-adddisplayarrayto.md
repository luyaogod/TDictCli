---
title: "ui.Dialog.addDisplayArrayTo"
source: "fgl-topics/c_fgl_ClassDialog_addDisplayArrayTo.html"
breadcrumb: "Library reference > Built-in packages > The ui package > The Dialog class > ui.Dialog methods > ui.Dialog.addDisplayArrayTo"
type: "concept"
---

# ui.Dialog.addDisplayArrayTo

> Adds a sub-dialog of type DISPLAY ARRAY TO to an existing ui.Dialog dynamic dialog.
...
The `ui.Dialog.addDisplayArrayTo()` class method adds a sub-dialog equivalent to a
`DISPLAY ARRAY TO` block, to the dynamic multiple dialog created with [ui.Dialog.createMultipleDialog](3175-ui-dialog-createmultipledialog.md "Creates an ui.Dialog object to implement a dynamic DIALOG multiple-dialog.").
...
The second parameter passed to the `addDisplayArrayTo()` method is the name of the
