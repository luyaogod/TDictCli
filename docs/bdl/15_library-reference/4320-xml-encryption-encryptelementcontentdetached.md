---
title: "xml.Encryption.encryptElementContentDetached"
source: "fgl-topics/c_gws_XmlEncryption_encryptElementContentDetached.html"
breadcrumb: "Library reference > Extension packages > The xml package > XML security classes > The Encryption class > Encryption methods > xml.Encryption.encryptElementContentDetached"
type: "concept"
---
...
Encrypts all child nodes of the element DomNode specified in *node* using the symmetric key,
and returns them as one new [EncryptedData](http://www.w3.org/TR/xmlenc-core/#sec-EncryptedData)
