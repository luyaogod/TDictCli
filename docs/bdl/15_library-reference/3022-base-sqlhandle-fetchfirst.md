---
title: "base.SqlHandle.fetchFirst"
source: "fgl-topics/c_fgl_ClassSqlHandle_fetchFirst.html"
breadcrumb: "Library reference > Built-in packages > The base package > The SqlHandle class > base.SqlHandle methods > base.SqlHandle.fetchFirst"
type: "concept"
---
...
Call the `fetchFirst()` method to fetch the first row in a scrollable SQL result
set.
