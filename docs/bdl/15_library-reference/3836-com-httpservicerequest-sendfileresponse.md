---
title: "com.HttpServiceRequest.sendFileResponse"
source: "fgl-topics/c_gws_ComHTTPServiceRequest_sendFileResponse.html"
breadcrumb: "Library reference > Extension packages > The com package > Web services classes > The HttpServiceRequest class > HttpServiceRequest methods > com.HttpServiceRequest.sendFileResponse"
type: "concept"
---
...
The `sendFileResponse()` method performs the HTTP response by sending the status
(code) and description (description), followed
by the headers previously set and the data contained in the specified file as body.
...
The resulting HTTP headers of the response will look
like:
