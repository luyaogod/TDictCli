...
source: "fgl-topics/c_gws_JSONSerializer_primitive_types_2.html"
breadcrumb: "Web services > Reference > JSON serialization rules and customization > Implicit and explicit conversion > Primitive type conversion"
type: "concept"
---
...
| `TRUE` | `true` | OK | OK |
| `FALSE` | `false` | OK | OK |
| `"true"` (`STRING` to `FGL-Boolean` assignment) | `null` | ERROR (unless authorized by [serializeNullAsDefault](../15_library-reference/3690-serializenullasdefault.md "Allow NULL values during serialization even when constraints are set, such as when JSONRequired is defined or when json_null=\"null\" is not defined.")) | OK |
...
| `"toto"` and with `allowImplicitConversion = 1` | - | ERROR | OKsilent cast to `NULL` | [allowImplicitConversion](../15_library-reference/3686-allowimplicitconversion.md "Allow implicit type conversions during JSON deserialization when the JSON property specifies one type, but the values suggest another.") does not help. |
| `{}` object | - | ERROR | ERROR |  |
| `[]` array | - | ERROR | ERROR |  |
...
**1.** Implicit conversion in [json.Serializer](../15_library-reference/3662-the-json-serializer-class.md "The json.Serializer class provides methods to serialize Genero BDL variable to JSON objects and vice versa.")
...
**2.** Implicit conversion in [json.Serializer](../15_library-reference/3662-the-json-serializer-class.md "The json.Serializer class provides methods to serialize Genero BDL variable to JSON objects and vice versa.")
was removed in version 6.00.00.
...
**3.** Implicit conversion in [json.Serializer](../15_library-reference/3662-the-json-serializer-class.md "The json.Serializer class provides methods to serialize Genero BDL variable to JSON objects and vice versa.")
was removed in version 6.00.00.
