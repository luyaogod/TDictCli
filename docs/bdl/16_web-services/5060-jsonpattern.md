---
title: "JSONPattern"
source: "fgl-topics/c_gws_JSON_attribute_JSONPattern_2.html"
breadcrumb: "Web services > Reference > JSON serialization rules and customization > json.Serializer attributes > JSONPattern"
type: "concept"
---
...
2. **Accepted BDL types**: The following types are accepted: `STRING`,
   ...
   unsupported types or on functions will result in [error-9156](../15_library-reference/4483-genero-bdl-errors.md).
...
4. **Validation**:
   ...
   - The regular expression is validated at compilation. An invalid regular expression will trigger
     [error-9157](../15_library-reference/4483-genero-bdl-errors.md).
