---
title: "JSONSelector"
source: "fgl-topics/c_gws_JSON_attribute_JSONSelector_2.html"
breadcrumb: "Web services > Reference > JSON serialization rules and customization > json.Serializer attributes > JSONSelector"
type: "concept"
---
...
`JSONSelector` is a mandatory attribute used with [JSONOneOf](../15_library-reference/3681-jsononeof.md "Defines a record that matches exactly one of several possible JSON schemas during serialization or deserialization.").
...
Every [`JSONOneOf`](../15_library-reference/3681-jsononeof.md "Defines a record that matches exactly one of several possible JSON schemas during serialization or deserialization.") record
