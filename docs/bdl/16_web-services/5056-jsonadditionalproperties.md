...
source: "fgl-topics/c_gws_JSON_attribute_JSONAdditionalProperties_2.html"
breadcrumb: "Web services > Reference > JSON serialization rules and customization > json.Serializer attributes > JSONAdditionalProperties"
type: "concept"
---
...
For the `JSONRequired` alternative, see [Example 2: using JSONOneOf with JSONRequired](../15_library-reference/3681-jsononeof.md).
