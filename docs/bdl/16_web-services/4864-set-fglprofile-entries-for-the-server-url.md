...
source: "fgl-topics/t_gws_ssl_config_cert_add_to_fglprofile_rest.html"
breadcrumb: "Web services > RESTful web services > RESTful Web services (low-level APIs) > Writing a Web services client application > Configure a WS client to access an HTTPS server > Set FGLPROFILE entries for the server URL"
type: "task"
---
