...
source: "fgl-topics/c_fgl_dialog_ON_CHANGE_5.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG control blocks > ON CHANGE block"
type: "concept"
