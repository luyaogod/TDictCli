...
source: "fgl-topics/c_fgl_dialog_ON_TIMER.html"
breadcrumb: "User interface > Dialog instructions > Prompt for values (PROMPT) > Using simple prompt inputs > Interaction blocks > ON TIMER block"
type: "concept"
