...
source: "fgl-topics/c_fgl_dialog_ON_DRAG_START.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON DRAG_START block"
type: "concept"
