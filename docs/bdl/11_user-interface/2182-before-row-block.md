...
source: "fgl-topics/c_fgl_dialog_BEFORE_ROW_4.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG control blocks > BEFORE ROW block"
type: "concept"
