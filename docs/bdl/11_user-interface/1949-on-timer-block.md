...
source: "fgl-topics/c_fgl_dialog_ON_TIMER_3.html"
breadcrumb: "User interface > Dialog instructions > Record input (INPUT) > Using simple record inputs > INPUT interaction blocks > ON TIMER block"
type: "concept"
