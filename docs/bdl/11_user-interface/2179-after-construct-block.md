...
source: "fgl-topics/c_fgl_dialog_AFTER_CONSTRUCT_3.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG control blocks > AFTER CONSTRUCT block"
type: "concept"
