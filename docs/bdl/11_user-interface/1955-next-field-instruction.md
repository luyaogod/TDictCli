...
source: "fgl-topics/c_fgl_dialog_NEXT_FIELD.html"
breadcrumb: "User interface > Dialog instructions > Record input (INPUT) > Using simple record inputs > INPUT control instructions > NEXT FIELD instruction"
type: "concept"
