...
source: "fgl-topics/c_fgl_dialog_ON_ACTION_5.html"
breadcrumb: "User interface > Dialog instructions > Query by example (CONSTRUCT) > Using query by example > CONSTRUCT interaction blocks > ON ACTION block"
type: "concept"
