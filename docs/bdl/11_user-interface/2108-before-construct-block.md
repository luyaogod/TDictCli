...
source: "fgl-topics/c_fgl_dialog_BEFORE_CONSTRUCT_2.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG control blocks > BEFORE CONSTRUCT block"
type: "concept"
