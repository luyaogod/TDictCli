...
source: "fgl-topics/c_fgl_dialog_ON_ACTION.html"
breadcrumb: "User interface > Dialog instructions > Ring menus (MENU) > Using ring menus > MENU interaction blocks > ON ACTION block"
type: "concept"
