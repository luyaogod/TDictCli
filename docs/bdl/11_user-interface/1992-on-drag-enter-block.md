...
source: "fgl-topics/c_fgl_dialog_ON_DRAG_ENTER.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON DRAG_ENTER block"
type: "concept"
