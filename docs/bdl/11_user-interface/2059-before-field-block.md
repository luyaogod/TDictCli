...
source: "fgl-topics/c_fgl_dialog_BEFORE_FIELD_4.html"
breadcrumb: "User interface > Dialog instructions > Query by example (CONSTRUCT) > Using query by example > CONSTRUCT control blocks > BEFORE FIELD block"
type: "concept"
