---
title: "ON IDLE block"
source: "fgl-topics/c_fgl_dialog_ON_IDLE.html"
breadcrumb: "User interface > Dialog instructions > Prompt for values (PROMPT) > Using simple prompt inputs > Interaction blocks > ON IDLE block"
type: "concept"
