...
source: "fgl-topics/c_fgl_dialog_NEXT_FIELD_2.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY control instructions > NEXT FIELD instruction"
type: "concept"
