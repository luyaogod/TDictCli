...
source: "fgl-topics/c_fgl_prog_dialogs_list_find_2.html"
breadcrumb: "User interface > User interface programming > Scrollgrid views > Finding rows matching a pattern"
type: "concept"
---
