---
title: "DATEEDIT item definition"
source: "fgl-topics/c_fgl_FormSpecFiles_DATEEDIT_Item_Type.html"
breadcrumb: "User interface > Form definitions > Form specification files > Form file structure > ATTRIBUTES section > DATEEDIT item definition"
type: "concept"
---
...
1. item-tag is an identifier that defines thename of the item tag in the layout section.
...
Class-specific: [`buttonIcon`](1635-dateedit-style-attributes.md), [`calendarType`](1635-dateedit-style-attributes.md), [`daysOff`](1635-dateedit-style-attributes.md), [`firstDayOfWeek`](1635-dateedit-style-attributes.md), [`showCurrentMonthOnly`](1635-dateedit-style-attributes.md), [`showWeekNumber`](1635-dateedit-style-attributes.md).
...
For more details about this item type, see [DATEEDIT item type](1688-dateedit-item-type.md "Defines a line-edit with a calendar widget to pick a date.").
