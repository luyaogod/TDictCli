...
source: "fgl-topics/c_fgl_dialog_ON_ACTION_3.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON ACTION block"
type: "concept"
