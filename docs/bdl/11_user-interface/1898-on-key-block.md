---
title: "ON KEY block"
source: "fgl-topics/c_fgl_dialog_ON_KEY.html"
breadcrumb: "User interface > Dialog instructions > Prompt for values (PROMPT) > Using simple prompt inputs > Interaction blocks > ON KEY block"
type: "concept"
