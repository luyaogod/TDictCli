...
source: "fgl-topics/c_fgl_dialog_ON_EXPAND.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY data blocks > ON EXPAND block"
type: "concept"
