...
source: "fgl-topics/c_fgl_dialog_ON_CHANGE_4.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG control blocks > ON CHANGE block"
type: "concept"
