...
source: "fgl-topics/c_fgl_dialog_AFTER_FIELD_2.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY control blocks > AFTER FIELD block"
type: "concept"
