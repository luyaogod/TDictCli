...
source: "fgl-topics/c_fgl_dialog_ON_TIMER_2.html"
breadcrumb: "User interface > Dialog instructions > Ring menus (MENU) > Using ring menus > MENU interaction blocks > ON TIMER block"
type: "concept"
