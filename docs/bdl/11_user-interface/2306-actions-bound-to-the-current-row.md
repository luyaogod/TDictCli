...
source: "fgl-topics/c_fgl_prog_dialogs_rowbound_actions_2.html"
breadcrumb: "User interface > User interface programming > List dialogs > Actions bound to the current row"
type: "concept"
---
