---
title: "ON DROP block"
source: "fgl-topics/c_fgl_dialog_ON_DROP.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON DROP block"
type: "concept"
