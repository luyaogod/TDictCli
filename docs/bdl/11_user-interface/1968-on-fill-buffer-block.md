...
source: "fgl-topics/c_fgl_dialog_ON_FILL_BUFFER.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY data blocks > ON FILL BUFFER block"
type: "concept"
