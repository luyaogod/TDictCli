...
source: "fgl-topics/c_fgl_dialog_ON_COLLAPSE_2.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG data blocks > ON COLLAPSE block"
type: "concept"
