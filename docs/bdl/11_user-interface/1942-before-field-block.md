...
source: "fgl-topics/c_fgl_dialog_BEFORE_FIELD.html"
breadcrumb: "User interface > Dialog instructions > Record input (INPUT) > Using simple record inputs > INPUT control blocks > BEFORE FIELD block"
type: "concept"
