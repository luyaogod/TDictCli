...
source: "fgl-topics/c_fgl_dialog_ON_DRAG_START_3.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG interaction blocks > ON DRAG_START block"
type: "concept"
