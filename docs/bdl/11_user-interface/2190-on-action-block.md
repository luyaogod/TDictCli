...
source: "fgl-topics/c_fgl_dialog_ON_ACTION_7.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG interaction blocks > ON ACTION block"
type: "concept"
