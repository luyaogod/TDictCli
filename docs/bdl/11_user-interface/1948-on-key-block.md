---
title: "ON KEY block"
source: "fgl-topics/c_fgl_dialog_ON_KEY_2.html"
breadcrumb: "User interface > Dialog instructions > Record input (INPUT) > Using simple record inputs > INPUT interaction blocks > ON KEY block"
type: "concept"
