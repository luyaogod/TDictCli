---
title: "SPINEDIT item definition"
source: "fgl-topics/c_fgl_FormSpecFiles_SPINEDIT_Item_Type.html"
breadcrumb: "User interface > Form definitions > Form specification files > Form file structure > ATTRIBUTES section > SPINEDIT item definition"
type: "concept"
---
...
`LIKE`](1840-validate-like-attribute.md "The VALIDATE LIKE attribute applies column attributes defined in the .val database schema files to a field."), [`VALUEMIN`](1841-valuemin-attribute.md "The VALUEMIN attribute defines a lower limit of values displayed in widgets (such as progress bars)."), [`VALUEMAX`](1842-valuemax-attribute.md "The VALUEMAX attribute defines a upper limit of values displayed in widgets (such as progress bars).").
...
Class-specific: none. [`showVirtualKeyboard`](1647-spinedit-style-attributes.md).

## Usage

Define the rendering and behavior of a spin edit [item tag](1679-item-tags.md "Item tags define the position and size in a grid-based container."),
with a `SPINEDIT` element in the `ATTRIBUTES` section.

For more details about this item type, see [SPINEDIT item type](1702-spinedit-item-type.md "Defines a spin box widget to enter integer values.").
