---
title: "ON IDLE block"
source: "fgl-topics/c_fgl_dialog_ON_IDLE_2.html"
breadcrumb: "User interface > Dialog instructions > Ring menus (MENU) > Using ring menus > MENU interaction blocks > ON IDLE block"
type: "concept"
