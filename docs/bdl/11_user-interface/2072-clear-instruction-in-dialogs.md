...
source: "fgl-topics/c_fgl_dialog_CLEAR_instruction_3.html"
breadcrumb: "User interface > Dialog instructions > Query by example (CONSTRUCT) > Using query by example > CONSTRUCT control instructions > CLEAR instruction in dialogs"
type: "concept"
