---
title: "DATETIMEEDIT item definition"
source: "fgl-topics/c_fgl_FormSpecFiles_DATETIMEEDIT_Item_Type.html"
breadcrumb: "User interface > Form definitions > Form specification files > Form file structure > ATTRIBUTES section > DATETIMEEDIT item definition"
type: "concept"
---

# DATETIMEEDIT item definition

> Defines attributes for a line-edit field with a calendar widget to pick a datetime.
...
Class-specific: [`buttonIcon`](1636-datetimeedit-style-attributes.md), [`calendarType`](1636-datetimeedit-style-attributes.md), [`daysOff`](1636-datetimeedit-style-attributes.md), [`firstDayOfWeek`](1636-datetimeedit-style-attributes.md), [`showCurrentMonthOnly`](1636-datetimeedit-style-attributes.md), [`showWeekNumber`](1636-datetimeedit-style-attributes.md).

## Usage

Define the rendering and behavior of a date edit [item tag](1679-item-tags.md "Item tags define the position and size in a grid-based container."),
with a `DATETIMEEDIT` element in the `ATTRIBUTES` section.

For more details about this item type, see [DATETIMEEDIT item type](1689-datetimeedit-item-type.md "Defines a line-edit with a calendar widget to pick a datetime.").
