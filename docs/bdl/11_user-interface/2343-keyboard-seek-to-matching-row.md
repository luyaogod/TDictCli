...
source: "fgl-topics/c_fgl_prog_dialogs_list_seek_2.html"
breadcrumb: "User interface > User interface programming > Scrollgrid views > Keyboard seek to matching row"
type: "concept"
---
