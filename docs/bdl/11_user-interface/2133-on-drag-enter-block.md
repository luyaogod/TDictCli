...
source: "fgl-topics/c_fgl_dialog_ON_DRAG_ENTER_2.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG interaction blocks > ON DRAG_ENTER block"
type: "concept"
