...
source: "fgl-topics/c_fgl_dialog_ON_FILL_BUFFER_2.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG data blocks > ON FILL BUFFER block"
type: "concept"
