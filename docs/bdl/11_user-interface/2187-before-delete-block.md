...
source: "fgl-topics/c_fgl_dialog_BEFORE_DELETE_3.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG control blocks > BEFORE DELETE block"
type: "concept"
