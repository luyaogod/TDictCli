...
source: "fgl-topics/c_fgl_FormSpecFiles_CANVAS_Item_Type.html"
breadcrumb: "User interface > Form definitions > Form specification files > Form file structure > ATTRIBUTES section > CANVAS item definition"
type: "concept"
---
