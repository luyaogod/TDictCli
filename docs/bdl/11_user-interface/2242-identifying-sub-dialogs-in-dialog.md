...
source: "fgl-topics/c_fgl_prog_dialogs_subdialog_ident_2.html"
breadcrumb: "User interface > User interface programming > Input fields > Identifying sub-dialogs in DIALOG"
type: "concept"
---
