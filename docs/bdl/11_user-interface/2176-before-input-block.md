...
source: "fgl-topics/c_fgl_dialog_BEFORE_INPUT_4.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG control blocks > BEFORE INPUT block"
type: "concept"
