...
source: "fgl-topics/c_fgl_DIALOG_block_INPUT_ARRAY_ATTRIBUTES.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > Procedural DIALOG block configuration > INPUT ARRAY ATTRIBUTES clause"
type: "concept"
---
