...
source: "fgl-topics/c_fgl_dialog_ON_APPEND.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON APPEND block"
type: "concept"
