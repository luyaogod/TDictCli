...
source: "fgl-topics/c_fgl_dialog_ON_SELECTION_CHANGE.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON SELECTION CHANGE block"
type: "concept"
