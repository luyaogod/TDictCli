...
source: "fgl-topics/c_fgl_dialog_BEFORE_INPUT_3.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG control blocks > BEFORE INPUT block"
type: "concept"
