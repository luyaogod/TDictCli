...
source: "fgl-topics/c_fgl_dialog_ON_UPDATE.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON UPDATE block"
type: "concept"
