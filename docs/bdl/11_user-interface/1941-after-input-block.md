...
source: "fgl-topics/c_fgl_dialog_AFTER_INPUT.html"
breadcrumb: "User interface > Dialog instructions > Record input (INPUT) > Using simple record inputs > INPUT control blocks > AFTER INPUT block"
type: "concept"
