...
source: "fgl-topics/c_fgl_dialog_BEFORE_INSERT_2.html"
breadcrumb: "User interface > Dialog instructions > Multiple dialogs (DIALOG - inside functions) > Using multiple dialogs > DIALOG control blocks > BEFORE INSERT block"
type: "concept"
