...
source: "fgl-topics/c_fgl_dialog_BEFORE_ROW.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY control blocks > BEFORE ROW block"
type: "concept"
