...
source: "fgl-topics/c_fgl_dialog_ON_TIMER_6.html"
breadcrumb: "User interface > Dialog instructions > Query by example (CONSTRUCT) > Using query by example > CONSTRUCT interaction blocks > ON TIMER block"
type: "concept"
