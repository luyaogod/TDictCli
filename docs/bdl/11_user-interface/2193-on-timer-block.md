...
source: "fgl-topics/c_fgl_dialog_ON_TIMER_8.html"
breadcrumb: "User interface > Dialog instructions > Declarative dialogs (DIALOG - at module level) > Using declarative dialogs > DIALOG interaction blocks > ON TIMER block"
type: "concept"
