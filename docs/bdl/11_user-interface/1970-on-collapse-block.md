...
source: "fgl-topics/c_fgl_dialog_ON_COLLAPSE.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY data blocks > ON COLLAPSE block"
type: "concept"
