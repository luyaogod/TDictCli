...
source: "fgl-topics/c_fgl_dialog_ON_INSERT.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON INSERT block"
type: "concept"
