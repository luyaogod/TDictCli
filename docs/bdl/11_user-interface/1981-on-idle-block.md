---
title: "ON IDLE block"
source: "fgl-topics/c_fgl_dialog_ON_IDLE_4.html"
breadcrumb: "User interface > Dialog instructions > Record list (DISPLAY ARRAY) > Using record lists > DISPLAY ARRAY interaction blocks > ON IDLE block"
type: "concept"
