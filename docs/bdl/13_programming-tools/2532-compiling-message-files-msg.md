...
source: "fgl-topics/c_fgl_message_files_004_2.html"
breadcrumb: "Programming tools > Compiling source files > Compiling message files (.msg)"
type: "concept"
---
...
.msg extension) must be compiled with the [fglmkmsg](2518-fglmkmsg.md "The fglmkmsg tool compiles .msg message files into a binary version used by programs.") utility to produce compiled message files (with
.iem extension).
