...
source: "fgl-topics/c_fgl_odiagmys_024.html"
breadcrumb: "SQL support > SQL database guides > Oracle® MySQL / MariaDB > Data manipulation > MATCHES and LIKE"
type: "concept"
...
MySQL and MariaDB do not provide an equivalent of the Informix `MATCHES` operator.
