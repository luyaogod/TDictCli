...
source: "fgl-topics/c_fgl_odiagpgs_026.html"
breadcrumb: "SQL support > SQL database guides > PostgreSQL > Data manipulation > String delimiters"
type: "concept"
...
PostgreSQL follows the ANSI SQL specification, using single quotes for string delimiters and
double quotes for database object names.
