...
source: "fgl-topics/c_fgl_odiagpgs_046.html"
breadcrumb: "SQL support > SQL database guides > PostgreSQL > Data manipulation > Row limiting clause"
type: "concept"
...
PostgreSQL supports the following row limiting
clause:
...
The Informix SQL row limiting clause can be converted by the PostgreSQL driver to the native SQL
equivalent clause, when the parameters are simple integer literals.
