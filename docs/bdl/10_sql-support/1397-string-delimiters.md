...
source: "fgl-topics/c_fgl_odiagora_029.html"
breadcrumb: "SQL support > SQL database guides > Oracle® Database > Data manipulation > String delimiters"
type: "concept"
...
ORACLE follows the ANSI SQL specification, using single quotes for string delimiters and double
quotes for database object names.
