...
source: "fgl-topics/c_fgl_odiagdmg_032.html"
breadcrumb: "SQL support > SQL database guides > Dameng® database server > BDL programming > Cursors WITH HOLD"
type: "concept"
...
Dameng can keep cursors open across transactions, when
the transaction is terminated with `COMMIT` or `ROLLBACK`.
