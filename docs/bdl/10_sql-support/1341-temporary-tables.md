...
source: "fgl-topics/c_fgl_odiagmys_019.html"
breadcrumb: "SQL support > SQL database guides > Oracle® MySQL / MariaDB > Data manipulation > Temporary tables"
type: "concept"
...
MySQL and MariaDB support temporary tables with the following
syntax:
...
In BDL, Informix temporary tables instructions are
converted to generate native SQL Server temporary tables.
