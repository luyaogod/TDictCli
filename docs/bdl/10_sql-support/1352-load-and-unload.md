...
source: "fgl-topics/c_fgl_odiagmys_032.html"
breadcrumb: "SQL support > SQL database guides > Oracle® MySQL / MariaDB > BDL programming > LOAD and UNLOAD"
type: "concept"
...
The `LOAD` and `UNLOAD` BDL instructions are supported with MySQL
and MariaDB.
