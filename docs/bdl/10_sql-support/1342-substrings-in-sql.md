...
source: "fgl-topics/c_fgl_odiagmys_020.html"
breadcrumb: "SQL support > SQL database guides > Oracle® MySQL / MariaDB > Data manipulation > Substrings in SQL"
type: "concept"
...
MySQL and MariaDB provide the function, to extract a substring from a string expression:
...
right-value expressions by `SUBSTRING(col,x,y-x+1)`.
