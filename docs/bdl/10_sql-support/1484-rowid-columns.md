---
title: "ROWID columns"
source: "fgl-topics/c_fgl_odiagsqt_006.html"
breadcrumb: "SQL support > SQL database guides > SQLite > Data dictionary > ROWID columns"
type: "concept"
...
If you cannot avoid the use of rowids, you must change the type of the variables which hold
`ROWID` values. Instead of using `INTEGER`, use
`DECIMAL(20)`.
