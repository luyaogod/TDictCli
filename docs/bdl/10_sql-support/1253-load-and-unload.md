...
source: "fgl-topics/c_fgl_odiagdmg_037.html"
breadcrumb: "SQL support > SQL database guides > Dameng® database server > BDL programming > LOAD and UNLOAD"
type: "concept"
...
Dameng does not provide `LOAD` and
`UNLOAD` instructions.
