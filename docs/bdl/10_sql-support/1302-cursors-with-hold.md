...
source: "fgl-topics/c_fgl_odiagmsv_033.html"
breadcrumb: "SQL support > SQL database guides > Microsoft™ SQL Server > BDL programming > Cursors WITH HOLD"
type: "concept"
...
Microsoft SQL Server does not close cursors when a
transaction ends.
