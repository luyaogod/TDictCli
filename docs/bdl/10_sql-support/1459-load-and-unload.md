...
source: "fgl-topics/c_fgl_odiagpgs_040.html"
breadcrumb: "SQL support > SQL database guides > PostgreSQL > BDL programming > LOAD and UNLOAD"
type: "concept"
...
The
`LOAD` and `UNLOAD` BDL instructions are supported with
PostgreSQL.
