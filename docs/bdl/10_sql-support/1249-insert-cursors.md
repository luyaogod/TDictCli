...
source: "fgl-topics/c_fgl_odiagdmg_029.html"
breadcrumb: "SQL support > SQL database guides > Dameng® database server > BDL programming > INSERT cursors"
type: "concept"
...
Dameng does not support insert cursors.
