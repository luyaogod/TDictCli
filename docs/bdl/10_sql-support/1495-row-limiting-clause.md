...
source: "fgl-topics/c_fgl_odiagsqt_046.html"
breadcrumb: "SQL support > SQL database guides > SQLite > Data manipulation > Row limiting clause"
type: "concept"
...
SQLite supports the following row limiting
clause:
...
The Informix SQL row limiting clause can be converted by the SQLite driver to the native SQL
