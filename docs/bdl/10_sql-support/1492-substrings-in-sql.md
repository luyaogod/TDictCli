...
source: "fgl-topics/c_fgl_odiagsqt_023.html"
breadcrumb: "SQL support > SQL database guides > SQLite > Data manipulation > Substrings in SQL"
type: "concept"
...
SQLite provides the `SUBSTR(expr, start, length)` function, to extract a substring
