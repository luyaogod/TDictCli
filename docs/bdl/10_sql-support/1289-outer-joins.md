---
title: "Outer joins"
source: "fgl-topics/c_fgl_odiagmsv_011.html"
breadcrumb: "SQL support > SQL database guides > Microsoft™ SQL Server > Data manipulation > Outer joins"
type: "concept"
...
Microsoft SQL Server supports the ANSI outer join
syntax:
...
> **Note:**
>
> The legacy syntax to define outers in SQL Server uses the `*=`
> notation:
>
> ```
