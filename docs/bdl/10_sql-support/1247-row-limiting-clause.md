...
source: "fgl-topics/c_fgl_odiagdmg_057.html"
breadcrumb: "SQL support > SQL database guides > Dameng® database server > Data manipulation > Row limiting clause"
type: "concept"
...
Dameng supports the following row limiting
clause:
...
The Informix SQL row limiting clause can be converted by the Dameng driver to the native
SQL equivalent clause, when the parameters are simple integer literals.
