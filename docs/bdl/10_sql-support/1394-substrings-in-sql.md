...
source: "fgl-topics/c_fgl_odiagora_027.html"
breadcrumb: "SQL support > SQL database guides > Oracle® Database > Data manipulation > Substrings in SQL"
type: "concept"
...
ORACLE provides the `SUBSTR()` function, to extract a substring from a string
expression:
