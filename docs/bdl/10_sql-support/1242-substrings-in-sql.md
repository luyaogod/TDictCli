...
source: "fgl-topics/c_fgl_odiagdmg_022.html"
breadcrumb: "SQL support > SQL database guides > Dameng® database server > Data manipulation > Substrings in SQL"
type: "concept"
...
Dameng provides different functions (`SUBSTR`,
`SUSTR2`, `SUBSTRING`), to extract a substring from a string expression:
...
right-value expressions by `SUBSTR(col,x,y-x+1)`.
