...
source: "fgl-topics/c_fgl_odiagmys_021.html"
breadcrumb: "SQL support > SQL database guides > Oracle® MySQL / MariaDB > Data dictionary > Name resolution of SQL objects"
type: "concept"
...
> **Important:**
>
> By default, table names are case sensitive on UNIX™, but not on macOS®
> and Windows®. For maximum portability,
> it is recommended to always use lowercase database object identifiers. For more details, search for
> the `lower_case_table_name` server parameter.
