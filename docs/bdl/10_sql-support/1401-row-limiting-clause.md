...
source: "fgl-topics/c_fgl_odiagora_046.html"
breadcrumb: "SQL support > SQL database guides > Oracle® Database > Data manipulation > Row limiting clause"
type: "concept"
...
Oracle® supports the following row
limiting
clause:
...
The Informix SQL row limiting clause can be converted by the Oracle driver to the native SQL equivalent clause, when the parameters are
