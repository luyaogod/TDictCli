...
source: "fgl-topics/c_fgl_operators_GREATER_OR_EQUAL.html"
breadcrumb: "Language basics > Operators > List of expression elements > Comparison operators > Greater or equal (>=)"
type: "concept"
---
...
Use the greater-or-equal operator to test if a value of the left operand is greater than or equal
