...
source: "fgl-topics/c_fgl_localized_strings_009.html"
breadcrumb: "Advanced features > Localization > Localized strings > Compiling string resource files (.str)"
type: "concept"
---
...
To compile a source string file, use the [fglmkstr](../13_programming-tools/2522-fglmkstr.md "The fglmkstr tool compiles .str localized string resource files.")
compiler.
