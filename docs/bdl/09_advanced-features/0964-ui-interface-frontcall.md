...
source: "fgl-topics/c_fgl_ClassInterface_frontCall.html"
breadcrumb: "Advanced features > Front calls > ui.Interface.frontCall"
type: "concept"
---
...
In mobile application [development](../17_mobile-applications/5083-mobile-development-mode.md "Set up a development environment to display app forms on a mobile front-end.") or [`runOnServer`](../15_library-reference/3458-mobile-runonserver.md "Run an application from the Genero Application Server using the specified URL.") mode, the
...
[`WHENEVER ERROR`](0850-whenever-directive.md "Use the WHENEVER directive to define how exceptions must be handled for the rest of the module.") directives or [`TRY/CATCH`](0853-try-catch-block.md "Use TRY / CATCH blocks to trap runtime exceptions in a delimited code block.") blocks can surround the front
call to avoid program stopping in case of error, and to check the error number returned in the [`status`](0939-status.md "status is a predefined variable that contains the execution status of the last instruction.") variable.
...
example, the [feInfo](../15_library-reference/3399-standard-feinfo.md "Queries general front-end properties.") front call will never
...
If the front call module name or the function name is invalid, the errors [-6331](../15_library-reference/4483-genero-bdl-errors.md) or [-6332](../15_library-reference/4483-genero-bdl-errors.md) will be raised,
respectively.

If the front call execution fails for some reason, the error [-6333](../15_library-reference/4483-genero-bdl-errors.md) will be raised. The
description of the problem can be found in the second part of the error message, returned by a call
to the [ERR\_GET()](../15_library-reference/2732-err-get.md "Returns the text corresponding to an error number.") function.

The error [-6334](../15_library-reference/4483-genero-bdl-errors.md) can be
...
[Front calls](0962-front-calls.md "Front call functions execute on the platform where the front-end is installed.")
